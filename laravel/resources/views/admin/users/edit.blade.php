...
@section('content')
        ...
        <link href="{{ asset('/css/validationEngine.jquery.css') }}" rel="stylesheet">
			...
			<div class="content fl">
				...
				<div class="inputCon">
					<div class="wh-bg">
						<span class="wh-fontBox">用户编辑</span>
					</div>
                    ...
                    <form class="validate" action="{{ URL('admin/users/'.$user->id) }}" method="POST" enctype="multipart/form-data">
                    <input name="_method" type="hidden" value="PUT">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
						<ul class="truckList">
							<li>
								<span><em class="star">*</em>用户名：</span>
                                <input type="text" name="name" class="mingzi form-control validate[required]" value="{{ $user->name }}">
							</li>
							<li>
								<span><em class="star">*</em>邮箱：</span>
                                <input type="text" name="email" class="mingzi form-control validate[required,custom[email]]" value="{{ $user->email}}">
							</li>
							<li>
								<span><em class="star"></em>密码：</span>
                                <input type="password" id="password" name="password" class="mingzi form-control">
								<span>（不修改密码勿填）</span>
							</li>
							<li>
								<span><em class="star"></em>确认密码：</span>
                                <input type="password" name="password_confirmation" class="mingzi form-control validate[condRequired[password],equals[password]]">
							</li>
							<li class="button">
								<span>&nbsp;</span>
